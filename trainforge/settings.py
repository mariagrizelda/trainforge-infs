...
SECRET_KEY = os.getenv(
    "DJANGO_SECRET_KEY",
    "django-insecure-dev-only-do-not-use-in-prod-ix*_ze@4t4__bir1)c+2_f5@hnk4",
)
...
if os.getenv("DB_ENGINE", "sqlite") == "mysql":
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("DB_NAME", "trainforge_db"),
...
ACCOUNT_ADAPTER = "core.adapters.TFAccountAdapter"

ACCOUNT_DEFAULT_HTTP_PROTOCOL = "http" if DEBUG else "https"

SOCIALACCOUNT_ADAPTER = "core.adapters.TFSocialAccountAdapter"
